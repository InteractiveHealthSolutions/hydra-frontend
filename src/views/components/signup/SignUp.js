...
class SignUp extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={(submitted && store.getState().registration.message !== '') || this.invalidPassword ? 'base-container-custom' : 'base-container'}>
                <h3 style={{ fontWeight: '200px', color: '#696969', marginLeft: '25px', marginTop: '5px', marginBottom: '-7px' }}>Add New User</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group row" style={{ marginLeft: '25px' }}>
                                ...
                                <div class="col-sm-6">
                                    <DatePicker selected={user.dateofbirth} onChangeRaw={this.handleDateChangeRaw} onChange={this.handleChangeDate} className="form-control date-picker" maxDate={new Date()} dateFormat="dd/MM/yyyy" placeholderText="Click to select a date" required />
                                </div>
                            </div>
                            <div className="form-group row" style={{ marginLeft: '25px' }}>
                        ...
                        <input type="text" className="form-control" style = {{marginLeft : '-50px'}} name="identifier" />
                            ...
                            <div className="form-group row" style={{ marginLeft: '50px' }}>
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <button type="submit" className="btn btn-primary" style={{ marginLeft: '20px' }}>Add User</button>
