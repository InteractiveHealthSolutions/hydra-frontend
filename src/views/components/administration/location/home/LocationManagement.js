...
class LocationManagement extends React.Component {
    ...
    async handleSubmit(e) {
        ...
        if(submit) {
            ...
            console.log("locationForm", JSON.stringify(locationForm))
                ...
                >
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <Modal.Body style={{ height: '309px', overflowY: 'auto' }} >
                            ...
                            <div className='form-group'>
                                <label htmlFor='parentLocation' className="required">Parent Location</label>
