    ...
    render() {
        ...
        return (
            <div className ="base-container">
                <span style={{ fontWeight: '220px', color: '#696969', marginLeft: '25px', marginTop: '5px', fontSize: 'larger' }}>Add New User</span>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group row" style={{ marginLeft: '25px' }}>
                                ...
                                <div class="col-sm-6">
                                    <DatePicker selected={user.dateofbirth} onChangeRaw={this.handleDateChangeRaw} onChange={this.handleChangeDate} className="form-control user-date-picker" maxDate={new Date()} dateFormat="dd/MM/yyyy" placeholderText="Click to select a date" required />
                                </div>
                            </div>
                            <div className="form-group row" style={{ marginLeft: '25px' }}>
