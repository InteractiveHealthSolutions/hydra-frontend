...
class EventList extends React.Component {
    ...
    deleteEvent = async (event) => {
        ...
        //                     name: event.name,
        //                     uuid: event.uuid,
        //                     location: event.location ? event.location.uuid : [],
        //                     eventType: event.eventType ? event.eventType.uuid : [],
        //                     schedule: {
        //                         scheduleId: event.schedule.scheduleId,
        //                         plannedDate: event.schedule.plannedDate,
    ...
    handleVoidSubmit = async e => {
        ...
        console.log("voidEvent", voidEvent);
        await this.props.saveEvent(voidEvent);
        await this.props.getAllEvents();
        this.closeVoidModal();
    }
    ...
    render() {
        const { eventName, memberList, serviceList, assetList, eventType, location, startDate, endDate, selectedLocation, locationData, selectedLocationType, fromDate, toDate, listItems } = this.state;
        if (this.props.isloading) return <Loaders />;
        return (
            <div className="main-event">
                <div className="row event-maincard-header">
                    <div className="col-sm-3 col-md-3">
                        <h2 className="header_title">Events List</h2>
                    </div>
                        ...
                        <div className="form-group">
                                ...
                                <ExpansionPanel style={{ width: '100%', margin: '18px' }}>
                                    ...
                                    >
                                        <div className='row'>
                                            ...
                                            <div className='col-sm-6'>
                                                <label style={{ marginLeft: '349px', color: '#fff' }}>$948</label>
                                            </div>
                                        </div>
                                    </ExpansionPanelSummary>
                            ...
                            <div className='row' style={{ marginBottom: '50px' }}>
                                ...
                                <div className="col-sm-4">
                                    <div class="card" >
                                        ...
                                        <div class="card-body" style={{ background: 'var(--label-color)', height: '50px', color: '#fff' }}>
                                            <h2 style={{ marginTop: '-15px', marginLeft: '67px' }} >151</h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div class="card" >
                                        ...
                                        <div class="card-body" style={{ background: 'var(--label-color)', height: '54px', color: '#fff' }}>
                                            <h2 style={{ marginTop: '-12px', marginLeft: '60px' }} >0.66</h2>
                                        </div>
                                ...
                                {/* <div className="col-sm-4">
                                        <div class="card" >
                                            <div class="card-header" style={{ background: '#fff', height: '40px' }}>
                                                <label style={{ fontSize: '13px' }} >Total number of patients found </label>
                                            </div>
                                            <div class="card-body" style={{ background: '#007bff', height: '54px', color: '#fff' }}>
                                                <h1 style={{ marginTop: '-16px', marginLeft: '60px' }} >500</h1>
                                            </div>
                            ...
                            <div className="row">
                                <div className="card" style={{ width: '100%', margin: '20px' }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        {/* <div className="row">
                                                <div className='col-sm-6'>
                                                    <label style={{ fontWeight: 'bold' }}>Start Time:</label> &nbsp;&nbsp; <label >09:00 AM</label>
                                                </div>
                                                <div className='col-sm-6'>
                                                    <label style={{ fontWeight: 'bold' }}>End Time:</label> &nbsp;&nbsp; <label >3:00 PM</label>
                                                </div>
                                            </div> */}
                                        <div className="row">
                                            <div className='col-sm-6'>
