                    ...
                    <Modal.Body>
                        <form onSubmit={this.savePatient}>
                            ...
                            <div className="form-group row" >
                                ...
                                <div class="col-sm-8">
                                    <input type="text" className="form-control" name="familyname" pattern="[a-zA-Z]+\s?[a-zA-Z]{1,25}" placeholder="max 25 characters (no space)" maxlength="25" value={patient.familyname} onChange={this.handleChange} required />
                                </div>
                            </div>
